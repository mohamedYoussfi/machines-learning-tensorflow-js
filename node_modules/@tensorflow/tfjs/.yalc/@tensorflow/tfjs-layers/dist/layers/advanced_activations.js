...
var PReLU = (function (_super) {
    ...
    function PReLU(config) {
        ...
        _this.supportsMasking = true;
        _this.alphaInitializer = initializers_1.getInitializer(config.alphaInitializer || _this.DEFAULT_ALPHA_INITIALIZER);
        _this.alphaRegularizer = regularizers_1.getRegularizer(config.alphaRegularizer);
        _this.alphaConstraint = constraints_1.getConstraint(config.alphaConstraint);

...
jasmine_util_1.describeWithFlags('packed depthwiseConv2D', test_util_1.WEBGL_ENVS, function () {
    var webglPackedBatchNormalizationSavedFlag = tf.ENV.get('WEBGL_PACK_DEPTHWISECONV');
    beforeAll(function () {
        tf.ENV.set('WEBGL_PACK_DEPTHWISECONV', true);
    });
    afterAll(function () {
        tf.ENV.set('WEBGL_PACK_DEPTHWISECONV', webglPackedBatchNormalizationSavedFlag);
    });
    ...
    it('input=1x4x4x1,f=2,s=2,d=1,p=valid,chMul=1', function () {
        var fSize = 2;
        var pad = 'valid';
        var stride = 2;
        var chMul = 1;
        ...
        var x = tf.tensor4d([
            0.230664, 0.987388, 0.0685208, 0.419224, 0.887861, 0.731641,
            0.0741907, 0.409265, 0.351377, 0.488833, 0.733151, 0.518603, 0.271681,
            0.388339, 0.361921, 0.586260
        ], [1, 4, 4, inDepth]);
        var w = tf.tensor4d([0.303873, 0.229223, 0.144333, 0.803373], [fSize, fSize, inDepth, chMul]);
        var result = tf.depthwiseConv2d(x, w, stride, pad);
        expect(result.shape).toEqual([1, 2, 2, 1]);
        var expected = [1.0123528, 0.456418, 0.570019, 0.864883];
        test_util_1.expectArraysClose(result, expected);
    });
    ...
    it('input=1x4x4x2,f=3,s=2,d=1,p=same,chMul=1', function () {
        var fSize = 3;
        var pad = 'same';
        var stride = 2;
        var chMul = 1;
        ...
        var x = tf.tensor4d([
            0.111057, 0.661818, 0.701979, 0.424362, 0.992854, 0.417599, 0.423036,
            0.500499, 0.368484, 0.714135, 0.456693, 0.531058, 0.636636, 0.345024,
            0.050630, 0.789682, 0.177473, 0.793569, 0.680834, 0.662993, 0.628252,
            0.016079, 0.974360, 0.663527, 0.827026, 0.699203, 0.768811, 0.303914,
            0.739766, 0.808709, 0.580810, 0.869389
        ], [1, 4, 4, inDepth]);
        var w = tf.tensor4d([
            0.614293, 0.0648011, 0.101113, 0.452887, 0.0582746, 0.426481,
            0.872743, 0.765767, 0.8248714, 0.308840, 0.4714178, 0.200848,
            0.391879, 0.518833, 0.3020929, 0.411819, 0.2635254, 0.584538
        ], [fSize, fSize, inDepth, chMul]);
        var result = tf.depthwiseConv2d(x, w, stride, pad);
        expect(result.shape).toEqual([1, 2, 2, 2]);
        var expected = [
            1.6362686, 1.8875048, 1.7906065, 1.0434191, 1.919163, 1.1502573,
            1.6091704, 1.1893295
        ];
        test_util_1.expectArraysClose(result, expected);
    });

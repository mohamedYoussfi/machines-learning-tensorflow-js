...
function irfft_(input) {
    ...
    if (innerDimensionSize <= 2) {
        var complexInput_1 = input.as2D(batch, innerDimensionSize);
        var ret = environment_1.ENV.engine.runKernel(function (backend) { return backend.ifft(complexInput_1); }, { complexInput: complexInput_1 });
        ...
        var complexInput_2 = complex_ops_1.complex(r, i).as2D(outputShape[0], outputShape[1]);
        var ret = environment_1.ENV.engine.runKernel(function (backend) { return backend.ifft(complexInput_2); }, { complexInput: complexInput_2 });
        return complex_ops_1.real(ret);
    }
}

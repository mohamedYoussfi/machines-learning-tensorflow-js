...
jasmine_util_1.describeWithFlags('IndexedDB', test_util_1.BROWSER_ENVS, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4, handler.save(artifacts1)];
                case 1:
                    saveResult = _a.sent();
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4, handler2.save(artifacts2)];
                case 2:
                    saveResult2 = _a.sent();
    ...
    it('Manager: List models: 0 result', function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4, new indexed_db_1.BrowserIndexedDBManager().listModels()];
                case 1:
                    models = _a.sent();
    ...
    it('Manager: List models: 1 result', function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    saveResult = _a.sent();
                    return [4, new indexed_db_1.BrowserIndexedDBManager().listModels()];
                case 2:
                    models = _a.sent();
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4, handler2.save(artifacts1)];
                case 2:
                    saveResult2 = _a.sent();
                    return [4, new indexed_db_1.BrowserIndexedDBManager().listModels()];
                case 3:
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    ...
                    return [4, manager.removeModel('QuxModel')];
                case 3:
                    _a.sent();
                    return [4, manager.listModels()];
                case 4:
                    models = _a.sent();
    ...
    it('Manager: Failed removeModel', function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4, new indexed_db_1.BrowserIndexedDBManager().removeModel('nonexistent')];
                case 1:
                    _a.sent();
